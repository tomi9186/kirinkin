import $ from 'jquery';
import 'wowjs'; // ili: import { WOW } from 'wowjs';
...
// Učini jQuery globalno dostupnim (potrebno za plugine koji ovise o window.$)
...
function slickInit() {
  if ($.exists('.cs_slider')) {
    $('.cs_slider').not('.slick-initialized').each(function () {
      // Slick Variable
      ...
      // Event handler NAKON inicijalizacije
  ...
  if ($.exists('.cs_gallery_slider_thumb')) {
    $('.cs_gallery_slider_thumb').not('.slick-initialized').slick({
      slidesToShow: 1,
      slidesToScroll: 1,
    ...
    $('.cs_gallery_slider_nav').not('.slick-initialized').slick({
      slidesToShow: 3,
      slidesToScroll: 1,
  ...
  if ($.exists('.cs_gallery_slider_thumb_2')) {
    $('.cs_gallery_slider_thumb_2').not('.slick-initialized').slick({
      slidesToShow: 1,
      slidesToScroll: 1,
    ...
    $('.cs_gallery_slider_nav_2').not('.slick-initialized').slick({
      slidesToShow: 3,
      slidesToScroll: 1,
